...
bool CliParser::isKeyUsed(const std::string& keyName, std::string& arg) const
{
...
bool CliParser::isKeyUsed(const std::string& keyName) const
{
  std::string arg;
  return isKeyUsed(keyName, arg);
}
